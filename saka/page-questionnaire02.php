    ...
    <div>
      <div id="question_area">
        <div id="q2" class="txt_display">
          <img src="<?php bloginfo('url'); ?>/images/questionnaire/kv02.png" alt="アーユルヴェーダ"/>
          <div class="question_box">
            <div class="question_text">
              <img src="<?php bloginfo('url'); ?>/images/questionnaire/text02.png" alt="アーユルヴェーダ"/>
            </div>
            <img src="<?php bloginfo('url'); ?>/images/questionnaire/image02.png" alt="アーユルヴェーダ"/>
            <div class="btn_area txt_display" style="display: flex;">
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire03/?q2_yes" class="q2_yes btn_yes">Yes</a>
              </p>
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire03/?q2_no" class="q2_no btn_no">No</a>
              </p>
            </div>
          </div>
        </div>
