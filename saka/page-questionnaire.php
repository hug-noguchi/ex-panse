    ...
    <div>
      <div id="question_area">
        <div id="q1" class="txt_display">
          <img src="<?php bloginfo('url'); ?>/images/questionnaire/kv01.png" alt="アーユルヴェーダ"/>
          <div class="question_box">
            <div class="question_text">
              <img src="<?php bloginfo('url'); ?>/images/questionnaire/text01.png" alt="アーユルヴェーダ"/>
            </div>
            <img src="<?php bloginfo('url'); ?>/images/questionnaire/image01.png" alt="アーユルヴェーダ"/>
            <div class="btn_area txt_display" style="display: flex;">
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire02/?q1_yes" class="q1_yes btn_yes">Yes</a>
              </p>
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire02/?q1_no" class="q1_no btn_no">No</a>
              </p>
            </div>
          </div>
        </div>
