...
<main>
	<div class="kv_box">
        ...
        <img src="<?php bloginfo('url'); ?>/images/lp/kv2_v4_sp.png" alt="エクスパンスセラピストへ" class="sp kv2">
				<img src="<?php bloginfo('url'); ?>/images/lp/kv_v4_pc.png" alt="エクスパンスセラピストへ" class="pc">
			</picture>
	...
	<div class="session js-animation">
		<picture>
			<source srcset="<?php bloginfo('url'); ?>/images/lp/session-lead_v3_sp.png" media="(max-width: 640px)">
			<img src="<?php bloginfo('url'); ?>/images/lp/session-lead_v3.png" alt="当日のお申し込みで総額50,000円相当の2大特典をプレゼント!!" width="671" height="90">
		</picture>
		<picture>
		...
		<a href="#reserve" id="cv_main_01">
			<picture>
				...
				<img src="<?php bloginfo('url'); ?>/images/lp/session-btn_v2.png" alt="無料体験説明会ご予約はこちら" width="800" height="134">
			</picture>
		</a>
	</div>
	...
	<div class="fixedBanner">
		<a href="#reserve" id="cv_bnr">
			<picture>
				<source srcset="<?php bloginfo('url'); ?>/images/lp/fixed-banner_v3_sp.png" media="(max-width: 640px)" />
				<img src="<?php bloginfo('url'); ?>/images/lp/fixed-banner_v4_pc.png" alt="無料体験説明会ご予約はこちら" />
			</picture>
		</a>
	</div>
</main>
